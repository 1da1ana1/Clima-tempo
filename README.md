# Previsão do Tempo – Aplicação Web
...
- Informações detalhadas de temperatura, umidade e velocidade do vento  
- Exibição do horário do sistema em tempo real  
- Alteração automática do tema e do plano de fundo conforme o período do dia (manhã, tarde ou noite)  
- Interface dinâmica e responsiva com manipulação direta do DOM  
- Requisições assíncronas utilizando **Fetch API** e **Async/Await**  

## Tecnologias e Skills Aplicadas

- **Linguagens:** HTML5, CSS3, JavaScript (ES6+)  
- **Integração de API:** OpenWeatherMap (RESTful)  
